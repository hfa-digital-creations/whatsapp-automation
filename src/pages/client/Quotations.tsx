    ...
    <div className="space-y-8 animate-glass-entrance">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Button onClick={() => setShowCreate((s) => !s)} className="text-xs">
          {showCreate ? 'Close Form' : '+ New Rate Template'}
        </Button>
      </div>
      ...
      <Tabs
        tabs={[
          { id: 'templates', label: 'Rate Card Templates', count: templates?.length ?? 0 },
          { id: 'history', label: 'Generated Quotes History', count: quotations?.length ?? 0 },
        ]}
        activeTab={activeTab}
      ...
      {/* Tab 2: Generated Quotations Log */}
