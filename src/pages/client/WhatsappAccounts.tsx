...
function QrPanel({ accountId }: { accountId: string }) {
  ...
  if (data.status === 'CONNECTED') {
    return (
      <div className="flex items-center justify-center gap-2 py-3 text-xs font-semibold text-emerald-600 dark:text-emerald-400 animate-tab-content">
  ...
  if (data.status === 'AUTHENTICATED') {
    return (
      <div className="flex items-center justify-center gap-2 py-3 text-xs text-slate-500 animate-tab-content">
        <Spinner />
