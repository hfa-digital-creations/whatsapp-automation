...
import { Badge, Button, Card, ErrorText, Input, Spinner, TabPanel, Tabs } from '../../components/ui';
...
function PairingCodePanel() {
  ...
  if (code) {
    return (
      <div className="flex flex-col items-center gap-3 text-center py-2 animate-tab-content">
  ...
  return (
    <div className="flex flex-col items-center gap-3 max-w-xs w-full py-2 animate-tab-content">
      <Input
      ...
      <Card className="p-8 max-w-xl mx-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            {status === 'CONNECTED' && (
              <div className="flex flex-col items-center gap-3 py-4 animate-tab-content">
            ...
            {status === 'AUTHENTICATED' && (
              <div className="py-4 flex flex-col items-center gap-2 animate-tab-content">
                <Spinner />
            ...
            {data?.running && status !== 'CONNECTED' && status !== 'AUTHENTICATED' && (
              <div className="w-full flex flex-col items-center gap-5">
                ...
                {/* Animated Tab Panels */}
                <TabPanel id="qr" activeTab={activeTab} className="w-full flex flex-col items-center gap-3">
                  {data?.qr ? (
                ...
                <TabPanel id="pairing" activeTab={activeTab} className="w-full flex flex-col items-center">
                  <PairingCodePanel />
                </TabPanel>
              </div>
            )}
